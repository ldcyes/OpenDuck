...
paths={'source':ROOT/'work/r13-electronics/inherited/Entry_5V_R8/Microduck_Entry_5V_R8.kicad_pcb','r22':R/'Microduck_Entry_5V_R22.kicad_pcb'}
NETS=['BAT_FUSED','BAT_MON','LOGIC_VIN','MOBILE_5V','BENCH_5V','SYSTEM_5V','GND']
