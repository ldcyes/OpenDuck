...
import bisect,math
P=OUT/('reduced_midtransfer_keypoints_v1.json'if args.prefix else'reduced_cycle_keypoints_v2.json');D=SOURCES.json(P);assert D['status']==('FROZEN_TRUE_RIGHT_STEP_PREFIX_NOT_A_COMPLETE_GAIT'if args.prefix else'GUARDED_TWO_TRUE_STEPS_EXACT_CYCLE_CANDIDATE_NOT_APPROVED')
assert args.prefix
TAG='midtransfer_v1'
