...
import bisect,math
P=OUT/('reduced_prefix_keypoints_v1.json'if args.prefix else'reduced_cycle_keypoints_v5.json');D=SOURCES.json(P);assert D['status']==('FROZEN_TRUE_RIGHT_STEP_PREFIX_NOT_A_COMPLETE_GAIT'if args.prefix else'GUARDED_TWO_TRUE_STEPS_EXACT_CYCLE_CANDIDATE_NOT_APPROVED')
assert not args.prefix, 'This frozen exporter is for the complete trajectory only'
TAG='4steps_v3'
