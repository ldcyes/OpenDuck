...
def main():
 ap=argparse.ArgumentParser();ap.add_argument('--selection',required=True);ap.add_argument('--boxes',required=True);ap.add_argument('--label',required=True);a=ap.parse_args();assert re.fullmatch("[a-z0-9_]+",a.label);sources={'work/r20-walking-fix/geometry/adjudicate_actual_anchors.py':'e36510ab295372463c66980af42b015335d16d6843782fe2fe4f7725530f1093'}
 def bind(p,h=None):
